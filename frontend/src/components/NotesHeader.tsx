...
export const NotesHeader: React.FC<NotesHeaderProps> = ({ rightActions }) => {
  return (
    <div className="notes-topbar">
      <div className="notes-topbar-inner">
        <div className="notes-brand" style={{gap: '.5rem'}}>
          {/* Home icon to the left of title */}
          <Link to="/" title="Home" aria-label="Home" className="icon-btn">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0h6" />
            </svg>
          </Link>
          {/* Light/Dark Mode Toggle */}
          <ThemeToggle buttonClassName="icon-btn" />
          {/* Settings icon */}
          <Link to="/setting" title="Settings" aria-label="Settings" className="icon-btn">
